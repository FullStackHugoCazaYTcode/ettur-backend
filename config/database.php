...
define('DB_NAME', getEnv('DB_NAME', 'ettur_recaudacion'));
...
define('JWT_SECRET', getEnv('JWT_SECRET', 'ettur_secret_key_change_in_production_2025'));
...
/**
 * Helper: obtener conexión rápida
 */
function db(): PDO {
